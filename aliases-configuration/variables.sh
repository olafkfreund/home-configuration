...
# Define PS1
export PS1="\\[$color_green\\][\\[$color_cyan\\]\$?\\[$color_green\\]]\\[$color_green\\][\\[$color_red\\]\t\\[$color_green\\]][\\[$color_yellow\\]\u\\[$color_green\\]@\\[$color_purple\\]\h\\[$color_green\\]:\\[$color_blue\\]\w\\[$color_green\\]]\\[$color_reset\\]\\[$color_green\\]\$(type get_git_current_branch > /dev/null 2>&1 && get_git_current_branch) \$(type screen_get_session_name > /dev/null 2>&1 && screen_get_session_name)\\[$color_reset\\]\n $ "
